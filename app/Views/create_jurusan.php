...
<?= $this->section('content') ?>
    ...
    <table>
        <tr>
            ...
            <input type="text" class="form-control <?= ($validation->hasError('nama_jurusan')) ? 'is-invalid' : ''; ?>" placeholder="Nama" aria-label="Nama" aria-describedby="basic-addon1" name="nama_jurusan" required>
